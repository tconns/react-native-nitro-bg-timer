...
- Source-of-truth files are `src/**`, `android/src/**`, `ios/**`, `nitro.json`.
- Generated/build artifacts:
  - `nitrogen/generated/**` (generated by `npm run specs`)
  - `lib/**` (generated by `npm run typescript`)
  - `*.tgz` package snapshots (generated by `npm pack`)
...
Performance checks (recommended before release):
